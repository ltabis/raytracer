...
fn get_sphere_color_test() {
    ...
    assert_eq!(
        sphere_1.material.texture.color((0.0, 0.0).into()).r,
        plane_ref.r
    );
    assert_eq!(
        sphere_1.material.texture.color((0.0, 0.0).into()).g,
        plane_ref.g
    );
    assert_eq!(
        sphere_1.material.texture.color((0.0, 0.0).into()).b,
        plane_ref.b
    );
    assert_eq!(
        sphere_1.material.texture.color((0.0, 0.0).into()).a,
        plane_ref.a
    );
}
