...
fn get_plane_color_test() {
    ...
    assert_eq!(
        plane_1.material.texture.color((0.0, 0.0).into()).r,
        plane_ref.r
    );
    assert_eq!(
        plane_1.material.texture.color((0.0, 0.0).into()).g,
        plane_ref.g
    );
    assert_eq!(
        plane_1.material.texture.color((0.0, 0.0).into()).b,
        plane_ref.b
    );
    assert_eq!(
        plane_1.material.texture.color((0.0, 0.0).into()).a,
        plane_ref.a
    );
}
